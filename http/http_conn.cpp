...
#define SYNSQL      //同步校验
//#define CGISQLPOOL //CGI多进程用连接池
//#define CGISQL     //CGI多进程不用连接池
...
const char *doc_root = "/home/xiaoliao/MyTinyWebserver/root";
...
bool http_conn::write() {
    ...
    while(1) {
        ...
        if(bytes_have_send >= m_iv[0].iov_len) {
            ...
            m_iv[0].iov_base = bytes_have_send + m_write_buf;
